...
def generate_launch_description():
    ...
    robots = [
        ...
        {'name': 'tb2', 'x_pose': '4.2', 'y_pose': '1.5', 'z_pose': 0.01},
        {'name': 'tb3', 'x_pose': '-4.2', 'y_pose': '-1.5', 'z_pose': 0.01},
        {'name': 'tb4', 'x_pose': '1.5', 'y_pose': '-1.5', 'z_pose': 0.01},
        {'name': 'tb5', 'x_pose': '4.2', 'y_pose': '-1.5', 'z_pose': 0.01},
        {'name': 'tb6', 'x_pose': '-4.2', 'y_pose': '1.5', 'z_pose': 0.01},
        # ...
        # ...
        ]
    ...
    world = os.path.join('/opt/ros/humble/share/turtlebot3_gazebo/worlds/turtlebot3_house.world')
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': '/home/qd/robot_ws/src/turtlebot3_multi_robot/map/my_map.yaml'},],
    ...
    for robot in robots:
        ...
        initial_pose_cmd = ExecuteProcess(
            cmd=['ros2', 'topic', 'pub', '-t', '15', '--qos-reliability', 'reliable', namespace + ['/initialpose'],
